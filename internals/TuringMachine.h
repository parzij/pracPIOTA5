...
typedef struct {
    ...
    TM_Transition trs[MaxSymbol];   // сами переходы             
} TM_State;
...
// Машина Тьюринга
typedef struct {
    TM_State states[MaxState]; // система команд                   
...
/*
 Подпрограмма для замены текущей ленты машины на новое слово
 Вход:
...
/*
 ...
 Вход :
    1) указатель на машину, у которой головка вышла за крайний левый узел
 Выход: (нет) – процедура
*/
...
/*
 ...
 Вход :
    1) указатель на машину, у которой головка вышла за крайний правый узел
 Выход: (нет) – процедура
*/
